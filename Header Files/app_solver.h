...
struct AppSolverDataParams {
    ...
    const int ofMinKPts, ofWinSize, ofMaxLevel, ofMaxCorn, peMinInl, peMinMatch, peNumIteR, bMaxSkFram, baProcIt, cFProcIt, peTMaxIter;
     ...
     * @param peTMaxIter pose estimation max track iteration
