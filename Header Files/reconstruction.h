...
public:
    Reconstruction(const std::string triangulateMethod, const std::string baMethod, const float minDistance, const float maxDistance, const float maxProjectionError, const bool useNormalizePts);
