...
VisPCL::VisPCL(const std::string windowName, const cv::viz::Color backgroundColor) {
...
boost::shared_ptr<pcl::visualization::PCLVisualizer> VisPCL::getNewViewer(const std::string windowName, const cv::viz::Color bColor) {
